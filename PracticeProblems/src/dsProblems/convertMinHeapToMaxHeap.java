...
public class convertMinHeapToMaxHeap {
    ...
    * Sifting down on a tree is better than sifting up because there are more
    * nodes at the bottom levels than at the top hence when sifting down there
    * are likely to be fewer movements
    * 
    * @param arr
    * @param index
    */
